...
public class PercolationTest {
    ...
    public void firstTest() {
        ...
        Cell[][] expectedState = {
                {Cell.CLOSED, Cell.FULL, Cell.CLOSED, Cell.CLOSED, Cell.CLOSED},
                {Cell.FULL, Cell.FULL, Cell.CLOSED, Cell.CLOSED, Cell.CLOSED},
                {Cell.CLOSED, Cell.CLOSED, Cell.OPEN, Cell.OPEN, Cell.CLOSED},
                {Cell.CLOSED, Cell.CLOSED, Cell.OPEN, Cell.CLOSED, Cell.CLOSED},
    ...
    public void checkerBoard() {
        ...
        Cell[][] expectedState = {
                {Cell.CLOSED, Cell.FULL, Cell.CLOSED, Cell.FULL, Cell.CLOSED},
                {Cell.FULL, Cell.FULL, Cell.FULL, Cell.FULL, Cell.FULL},
                {Cell.FULL, Cell.FULL, Cell.CLOSED, Cell.FULL, Cell.CLOSED},
                {Cell.FULL, Cell.FULL, Cell.FULL, Cell.CLOSED, Cell.OPEN},
